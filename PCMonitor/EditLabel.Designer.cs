namespace EspMon
{
	partial class EditLabel
	{
		...
		private void InitializeComponent()
		{
			...
			this.ValueTree.AfterSelect += new System.Windows.Forms.TreeViewEventHandler(this.treeView1_AfterSelect);
			// 
			// label4
			// 
			...
			// MaxText
			// 
			this.MaxText.Location = new System.Drawing.Point(123, 297);
